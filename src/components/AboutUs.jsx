...
const trustFeatures = [
  {
    ...
    icon: (
      <svg className="w-6 h-6 text-[#0B72B9]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6 text-[#0B72B9]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 3v1m0 16v1m9-9h-1M4 9H3m15.364-3.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707m12.728 12.728A9 9 0 115.636 5.636m12.728 12.728A9 9 0 015.636 5.636z" />
      </svg>
    ),
  },
  {
...
export default function AboutUs() {
  return (
    // Ensure mt-0 is locked here so it remains tightly flush with the Hero section above
    <section id="about-us" className="py-20 bg-[#C2E7FF] mt-0 relative overflow-hidden">
      
      {/* Decorative fine background line string */}
      <div className="absolute right-10 top-1/4 w-32 h-32 pointer-events-none opacity-30 hidden lg:block">
        <svg viewBox="0 0 100 100" fill="none" stroke="#0B72B9" strokeWidth="0.5" strokeDasharray="3 3">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        {/* LEFT COLUMN: Feature Brand Image Frame */}
        <div className="lg:col-span-5 flex justify-center">
          <div className="relative group w-full max-w-[420px]">
            ...
            <div className="w-full h-[320px] md:h-[380px] rounded-[2.2rem] overflow-hidden border border-white/40 shadow-xl bg-[#F4F9FC]">
              ...
              />
              <div className="hidden w-full h-full bg-gradient-to-tr from-[#C2E7FF]/60 to-[#0B72B9]/20 items-center justify-center p-6 text-center">
                <span className="text-xs font-bold text-[#0B72B9]">[ Place Waterfall Glass Image here ]</span>
              </div>
            </div>
          </div>
        </div>

        {/* RIGHT COLUMN: Rich Content & Feature Badges */}
        <div className="lg:col-span-7 space-y-6 text-left lg:pl-4">
          ...
          <p className="text-sm md:text-base text-gray-700 leading-relaxed font-semibold max-w-2xl opacity-90">
            At Altair, we believe that pure water is the foundation of a healthy life. Our state-of-the-art purification process ensures that every drop you drink is safe, clean, and refreshingly pure.
          </p>
