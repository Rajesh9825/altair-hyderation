...
const processSteps = [
  {
    ...
    icon: (
      <svg className="w-5 h-5 text-[#0B72B9]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a6 6 0 01-6-6c0-4 6-11 6-11s6 7 6 6a6 6 0 01-6 6z" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5 text-[#0B72B9]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a7 7 0 10-14 0v2" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5 text-[#0B72B9]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5 text-[#0B72B9]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 3h6v3H9zM7 6h10v14a2 2 0 01-2 2H9a2 2 0 01-2-2V6z" />
      </svg>
    )
  }
];
...
export default function QualityProcess() {
  return (
    <section 
      ...
      style={{ backgroundImage: "url('src/assets/Qualityprocess.png')" }}
    >
      
      {/* Structural layout wrapper grid to limit flow content exactly onto the left 7 columns */}
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
        
        {/* LEFT COMPONENT COLUMN (Occupies 7/12 layout columns exactly like Image 2) */}
        <div className="lg:col-span-7 flex flex-col items-start text-left space-y-10 w-full">
          ...
          <div className="relative w-full pt-2">
            ...
            {/* Horizontal tracking dashed connection vector row element line background line */}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-x-3 gap-y-8 items-start">
              {processSteps.map((step, idx) => (
                <div key={step.id} className="flex flex-col items-center text-center group relative">
                  ...
                  {/* Glass Circle Node Container Component */}
                  ...
                  {/* Mobile responsive connector step tracking indicators */}
        ...
        {/* RIGHT BLANK COLUMN BLOCK (Occupies 5 columns to cleanly frame your water splash and splash drops safely) */}
